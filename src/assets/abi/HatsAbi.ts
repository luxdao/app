export const HatsAbi = [
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'uint256', name: 'roleId', type: 'uint256' },
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'uint256', name: 'roleId', type: 'uint256' }],
  ...
  {
    inputs: [
      { internalType: 'uint32', name: '_topRoleDomain', type: 'uint32' },
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256[]', name: '_roleIds', type: 'uint256[]' },
    ],
    name: 'balanceOfBatch',
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_roleId', type: 'uint256' }],
    name: 'checkHatStatus',
  ...
  {
    inputs: [{ internalType: 'uint32', name: '_topRoleDomain', type: 'uint32' }],
