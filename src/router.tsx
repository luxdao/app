...
import { SafeTownHallPage } from './pages/dao/town-hall/SafeTownHallPage';
import { SafeTownHallSessionPage } from './pages/dao/town-hall/SafeTownHallSessionPage';
      ...
      children: [
        ...
        },
        {
          ...
          children: [
            ...
            {
              path: DAO_ROUTES.townHall.path,
              children: [
                {
                  index: true,
                  element: <SafeTownHallPage />,
                },
                {
                  path: ':sessionId',
                  element: <SafeTownHallSessionPage />,
                },
              ],
            },
          ],
