...
import { GovernorTokenDetails } from '../../../components/DaoCreator/formComponents/GovernorTokenDetails';
...
export function SafeDeployTokenPage() {
  ...
  const { prepareGovernorERC20FormData } = usePrepareFormData();
    ...
    <Formik<Pick<CreatorFormState, 'essentials' | 'erc20Token'>>
      initialValues={{
        ...
        essentials: {
          ...
          governance: GovernanceType.GOVERNOR_ERC20,
          snapshotENS: '',
        },
      }}
      ...
      onSubmit={async values => {
        ...
        const daoData = await prepareGovernorERC20FormData({
          ...initialState.essentials,
          ...initialState.governor,
          ...modifiedValues,
