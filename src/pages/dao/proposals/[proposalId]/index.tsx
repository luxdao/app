...
import { GovernorProposalDetails } from '../../../../components/Proposals/GovernorDetails';
...
import { GovernorProposal, SnapshotProposal } from '../../../../types';
...
export function SafeProposalDetailsPage() {
  ...
  const {
    governance: { proposals, loadingProposals, allProposalsLoaded, isGovernor },
    node: { safe },
  } = useDAOStore({ daoKey });
  ...
  return (
    <div>
      ...
      {contextProposal === undefined ? (
        ...
        <GovernorProposalDetails proposal={contextProposal as GovernorProposal} />
      ) : (
