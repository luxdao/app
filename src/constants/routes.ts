...
const getRoleQueryParam = (addressPrefix: string, safeAddress: string, roleId: Hex) =>
  `${getDaoQueryParam(addressPrefix, safeAddress)}&roleId=${roleId}`;
...
export const DAO_ROUTES = {
  ...
  rolesDetails: {
    relative: (addressPrefix: string, safeAddress: string, roleId: Hex) =>
      `/roles/details${getRoleQueryParam(addressPrefix, safeAddress, roleId)}`,
    path: 'roles/details',
  },
  rolesEdit: {
    relative: (addressPrefix: string, safeAddress: string) =>
  ...
  rolesEditDetails: {
    relative: (addressPrefix: string, safeAddress: string, roleId: Hex) =>
      `/roles/edit/details${getRoleQueryParam(addressPrefix, safeAddress, roleId)}`,
  ...
  townHall: {
    relative: (addressPrefix: string, safeAddress: string) =>
      `/town-hall${getDaoQueryParam(addressPrefix, safeAddress)}`,
    path: 'town-hall',
  },
  townHallSession: {
    relative: (addressPrefix: string, safeAddress: string, sessionId: string) =>
      `/town-hall/${sessionId}${getDaoQueryParam(addressPrefix, safeAddress)}`,
    path: 'town-hall/:sessionId',
  },
};
