...
import { RoleFormValues, RoleFormValue, SablierPaymentFormValues } from '../../../types/roles';
...
const getPaymentValidationContextData = (cxt: any) => {
  ...
  return {
    ...
    parentAssetAddress,
    formContextHats: formContext.hats as RoleFormValue[],
  };
};
    ...
    () =>
      Yup.object<RoleFormValues>().shape({
        roleEditing: Yup.object()
          ...
          .nullable()
          .when({
            is: (roleEditing: RoleFormValue) => roleEditing !== undefined,
