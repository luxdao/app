...
const contractTests: ContractFunctionTest[] = [
  ...
  {
    abi: combineAbis(legacy.abis.GovernorFreezeGuard, legacy.abis.MultisigFreezeGuard),
    functionNames: ['freezeVoting', 'owner'],
    revertFunctionNames: ['childGnosisSafe', 'timelockPeriod', 'executionPeriod'],
    resultKey: 'isFreezeGuardGovernor',
  },
  {
  ...
  },
  {
    ...
    resultKey: 'isModuleGovernor',
  },
  {
    abi: combineAbis(legacy.abis.FractalModule, legacy.abis.Governor),
