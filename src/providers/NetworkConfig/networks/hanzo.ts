...
// Define Hanzo Network chain (AI Chain)
const hanzo: Chain = {
  id: 36963,
  name: 'Hanzo Network',
  nativeCurrency: {
...
export const hanzoConfig: NetworkConfig = {
  order: 2,
  chain,
  rpcEndpoint: 'https://rpc.hanzo.ai',
  safeBaseURL: '',
  etherscanBaseURL: 'https://explorer.hanzo.ai',
  etherscanAPIUrl: '',
  addressPrefix: 'hanzo',
