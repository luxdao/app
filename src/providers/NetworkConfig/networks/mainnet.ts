...
export const mainnetConfig: NetworkConfig = {
  ...
  contracts: {
    ...
    linearVotingErc20RolesWhitelistingV1MasterCopy: getAddressFromContractDeploymentInfo(
    ...
    linearVotingErc721RolesWhitelistingV1MasterCopy: getAddressFromContractDeploymentInfo(
