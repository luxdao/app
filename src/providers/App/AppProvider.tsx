...
export const useDAOStore = ({ daoKey }: { daoKey: DAOKey | undefined }): FractalStoreWithNode => {
  ...
  if (!daoKey) {
    return {
      ...
      governanceContracts: {
        ...
        linearVotingErc20WithRolesWhitelistingAddress: undefined,
        linearVotingErc721Address: undefined,
        linearVotingErc721WithRolesWhitelistingAddress: undefined,
        moduleGovernorAddress: undefined,
  ...
  return {
    ...
    governanceContracts: {
      ...
      moduleGovernorAddress: governance.moduleGovernorAddress,
