...
export function PaymentWithdrawModal({
  ...
  withdrawInformation: {
    roleSmartAccountAddress: Address | undefined;
    recipient: Address;
  ...
  const handleWithdraw = useCallback(async () => {
    if (
      ...
      contractCall({
        contractFn: () => {
          if (!withdrawInformation.roleSmartAccountAddress) {
          ...
          const hatsAccountContract = getContract({
            ...
            address: withdrawInformation.roleSmartAccountAddress,
            client: walletClient,
          });
          return hatsAccountContract.write.execute([
            paymentContractAddress,
            0n,
            rolesAccountCalldata,
            0,
          ]);
        },
    ...
    paymentStreamId,
    walletClient,
    withdrawInformation.roleSmartAccountAddress,
    withdrawInformation.recipient,
    contractCall,
    t,
    onSuccess,
