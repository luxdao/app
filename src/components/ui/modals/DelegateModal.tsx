...
import { GovernorGovernance, DAOGovernance } from '../../../types';
...
export function DelegateModal({ close }: { close: Function }) {
  ...
  const daoGovernance = governorGovernance as DAOGovernance;
  const delegateeDisplayName = useGetAccountName(governorGovernance?.votesToken?.delegatee);
  ...
  if (!governorGovernance.votesToken) return null;
  ...
  return (
    <Box>
      ...
      >
        ...
        >
          {formatCoin(
            governorGovernance.votesToken.balance || 0n,
            false,
            governorGovernance.votesToken.decimals,
            governorGovernance.votesToken.symbol,
          )}
        </Text>
        <Text
          align="start"
        ...
        <Text
          ...
          color="color-neutral-300"
        >
          {governorGovernance.votesToken.delegatee === zeroAddress ? (
            '--'
          ) : (
            <EtherscanLink
              type="address"
              value={governorGovernance.votesToken.delegatee}
            >
          ...
          <form onSubmit={handleSubmit}>
            ...
            <Button
              ...
              isDisabled={
                ...
                pending ||
                !values.address ||
                values.address === governorGovernance.votesToken?.delegatee
              }
            >
              {t('buttonDelegate')}
            </Button>
