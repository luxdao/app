...
import { GovernorGovernance, CreateProposalTransaction, ProposalActionType } from '../../../types';
...
export function ConfirmDeleteStrategyModal({
  ...
  const handleDeleteStrategy = async () => {
    if (!safe || !governanceContracts.moduleGovernorAddress) {
      return;
    }

    if (
      !governanceContracts.linearVotingErc20WithRolesWhitelistingAddress &&
      !governanceContracts.linearVotingErc721WithRolesWhitelistingAddress
    ) {
    ...
    if (governanceContracts.linearVotingErc20Address) {
      ...
      transaction = {
        targetAddress: governanceContracts.moduleGovernorAddress,
        ethValue: {
          bigintValue: 0n,
          value: '0',
        },
      ...
      content: (
        <SafePermissionsStrategyAction
          ...
          proposerThreshold={{
            ...
            bigintValue: governorGovernance.votingStrategy?.proposerThreshold?.value,
          }}
        />
      ),
