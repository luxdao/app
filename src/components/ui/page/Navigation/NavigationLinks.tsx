...
import { FeatureFlagKey } from '../../../../helpers/featureFlags';
...
function InternalLinks({ closeDrawer }: { closeDrawer?: () => void }) {
  ...
  const isTownHallEnabled = useFeatureFlag('flag_town_hall' as FeatureFlagKey);
  ...
  return (
    ...
    >
      ...
      >
        ...
        {isTownHallEnabled && (
          <NavigationLink
            href={DAO_ROUTES.townHall.relative(addressPrefix, safeAddress)}
            labelKey="townHall"
            testId="navigation-townHallLink"
