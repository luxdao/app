...
import { GovernorProposal, FractalProposalState, SnapshotProposal } from '../../../types';
import { useVoteContext } from '../ProposalVotes/context/VoteContext';
import { CastVote } from './CastVote';
import { Execute } from './Execute';

function ProposalActions({ proposal }: { proposal: GovernorProposal | SnapshotProposal }) {
...
export function GovernorOrSnapshotProposalAction({
  proposal,
}: {
  proposal: GovernorProposal | SnapshotProposal;
}) {
