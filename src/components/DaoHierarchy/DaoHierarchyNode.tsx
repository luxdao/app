...
export function DaoHierarchyNode({
  ...
  const getVotingStrategies = useCallback(
    async (governorModule: DAOModule) => {
  ...
  const getGovernanceTypes = useCallback(
    async (governorModule: DAOModule) => {
      const votingStrategies = await getVotingStrategies(governorModule);
  ...
  const loadDao = useCallback(
    async (_safeAddress: Address): Promise<DaoHierarchyInfo | undefined> => {
      ...
      try {
        ...
        const votingStrategies: DaoHierarchyStrategyType[] = governorModule
          ? await getGovernanceTypes(governorModule)
          : ['MULTISIG'];
