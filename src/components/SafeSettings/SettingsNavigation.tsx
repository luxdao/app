...
import { GovernorGovernance, GovernanceType } from '../../types';
      ...
      {!safe ? (
        ...
        <>
          ...
          <SettingsNavigationItem
            ...
            hasEdits={values.governor !== undefined || values.multisig !== undefined}
          >
            <Text color="color-neutral-300">
              {t(governorGovernance.votingStrategy?.strategyType ?? 'labelMultisig')}
            </Text>
          </SettingsNavigationItem>
          <SettingsNavigationItem
          ...
          {governance.isGovernor && (
            ...
            >
              <Text color="color-neutral-300">{governorGovernance.votingStrategy ? 1 : 0}</Text>
            </SettingsNavigationItem>
          )}
          {!governance.isGovernor && isTokenDeploymentEnabled && (
            <SettingsNavigationItem
              title={t('tokenTitle')}
