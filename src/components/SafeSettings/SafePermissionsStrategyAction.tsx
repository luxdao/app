...
import { GovernorGovernance, BigIntValuePair, ProposalActionType } from '../../types';
  ...
  return (
    ...
    >
      ...
      <Text
        ...
        color="color-lilac-100"
      >
        {` ${proposerThreshold.value} ${governorGovernance.votesToken?.symbol || t('votingWeightThreshold')} `}
      </Text>
