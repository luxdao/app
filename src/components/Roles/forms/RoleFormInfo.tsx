...
export default function RoleFormInfo() {
  ...
  const { rolesTree, rolesTreeId } = useRolesStore();
  ...
  return (
    <>
      ...
      {/* @dev - deploying whitelisting voting strategy is feasible from UI/UX standpoint only when Safe has Governor module AND rolesTree been created already */}
      {type !== GovernanceType.MULTISIG && !!rolesTree && !!rolesTreeId && (
        <FormControl>
