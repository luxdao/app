...
export function EstablishEssentials(props: ICreationStepProps) {
  ...
  const handleGovernanceChange = (value: GovernanceType) => {
    if (value === GovernanceType.GOVERNOR_ERC20) {
      setFieldValue('governor.votingStrategyType', VotingStrategyType.LINEAR_ERC20);
    } else if (value === GovernanceType.GOVERNOR_ERC721) {
      setFieldValue('governor.votingStrategyType', VotingStrategyType.LINEAR_ERC721);
    }
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              {createOptions.includes(GovernanceType.GOVERNOR_ERC20) && (
                <RadioWithText
                  label={t('labelGovernorErc20Gov')}
                  description={t('descGovernorErc20Gov')}
                  testId="choose-governor"
                  value={GovernanceType.GOVERNOR_ERC20}
                />
              )}
              {createOptions.includes(GovernanceType.GOVERNOR_ERC721) && (
                <RadioWithText
                  label={t('labelGovernorErc721Gov')}
                  description={t('descGovernorErc721Gov')}
                  testId="choose-governor-erc721"
                  value={GovernanceType.GOVERNOR_ERC721}
                />
              )}
