...
import { GovernorTokenAllocations } from './GovernorTokenAllocations';
...
export function GovernorTokenDetails(props: ICreationStepProps & { withSteps: boolean }) {
    ...
    <>
      ...
      {values.erc20Token.tokenCreationType === TokenCreationType.NEW && (
        <Box
          ...
          borderRadius="0.25rem"
        >
          <GovernorTokenAllocations {...props} />
        </Box>
      )}
