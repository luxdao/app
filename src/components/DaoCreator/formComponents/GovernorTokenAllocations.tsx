...
import { GovernorTokenAllocation } from './GovernorTokenAllocation';

export function GovernorTokenAllocations(props: ICreationStepProps) {
  ...
  const canReceiveParentAllocations = isSubDAO && governorGovernance.votesToken?.address;
